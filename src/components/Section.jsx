...
const Section = () => {
  return (
    <div>
      ...
      <div>
        <img className="w-38 rounded-full h-48" src="/section/cb29acdc6551cbfbd85e7d8ec3209946.jpg" alt="" />
        <h3 className="text-xl font-bold">Shadow Strikers</h3>
        <p className="py-6">"Strike from the Shadows, Conquer <br /> the Battlefield!"</p>
      </div>

      <div>
        <img className="w-38 rounded-full h-48" src="/section/draw-you-as-your-favorite-video-game-character.png" alt="" />
        <h3 className="text-xl font-bold">Inferno Quest </h3>
        <p className="py-6">"Unleash the Fury of <br /> the Forgotten Gods!"</p>
      </div>

      <div>
        <img className="w-38 rounded-full h-48" src="/section/images (8).jpeg" alt="" />
        <h3 className="text-xl font-bold">Titan’s Wrath </h3>
        <p className="py-6">"Unleash the Fury of <br /> the Forgotten Gods!"</p>
      </div>

      <div>
        <img className="w-38 rounded-full h-48" src="/section/images (9).jpeg" alt="" />
