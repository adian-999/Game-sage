...
const AddGame = () => {
  ...
  const handleSubmit=(e)=>{
    ...
    .then(data=>{
       ...
       if(data.insertedId){
        Swal.fire({
          title: "Successfully Added the game review",
          icon: "success",
          draggable: true
        });
       }
  ...
  return (
    <div style={{ fontFamily: 'Kranky, serif' }}>
      ...
      <p className="text-amber-950 w-11/12 sm:w-2/4 mx-auto text-center">
        Add your favorite game to our growing collection! Submit details, upload a cover, and share your experience with other gamers. Whether you're a player or developer, showcase your game and help others discover new adventures.
      </p>
      ...
      <form onSubmit={handleSubmit} className="text-center bg-purple-200 mt-6 sm:mt-12 p-6 sm:p-12 w-full sm:w-7/12 mx-auto rounded-3xl shadow-xl my-6 sm:my-12 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="form-control">
            <label className="input-group">
              ...
              <input name="name" placeholder="Game Name" type="text" className="input input-bordered w-full" />
            </label>
          </div>
          ...
          <div className="form-control">
            <label className="input-group">
              ...
              <input name="email" placeholder="User Email" type="email" className="input input-bordered w-full" />
            </label>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4">
          <div className="form-control">
            <label className="input-group">
              ...
              <input name="userName" placeholder="User Name" type="text" className="input input-bordered w-full" />
            </label>
          </div>
          ...
          <div className="form-control">
            <label className="input-group">
              ...
              <input name="rating" placeholder="Rating" type="text" className="input input-bordered w-full" />
            </label>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4">
          <div className="form-control">
            <label className="input-group">
              ...
              <input name="year" placeholder="Publishing Year" type="text" className="input input-bordered w-full" />
            </label>
          </div>
          ...
          <div className="form-control">
            <label className="input-group">
              ...
              <input name="details" placeholder="Details" type="text" className="input input-bordered w-full" />
            </label>
          </div>
        </div>
        ...
        <div className="form-control my-4">
          <label className="input-group">
            ...
            <input name="photo" placeholder="Photo URL" type="url" className="input input-bordered w-full" />
          </label>
        </div>
        ...
        {/* Submit Button */}
        <input className="btn btn-block my-6 bg-purple-950 text-white hover:bg-purple-700 transition" value="Add Review" type="submit" />
      </form>
